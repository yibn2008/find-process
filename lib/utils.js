...
const utils = {
   ...
   * ```
   *
   * @param  {String} data raw list data
   * @param  {String} delimiter delimiter between header and value "Header ${delimiter} Value"
   * @return {Array}
   */
  parseList (data, delimiter) {
    ...
    return lines.map(line => {
      const row = {}
      line.forEach((string) => {
        const splitterIndex = string.indexOf(delimiter)
